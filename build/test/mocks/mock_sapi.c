...
void gpioWrite(gpioMap_t cmock_arg1, _Bool cmock_arg2)
{
  UNITY_LINE_TYPE cmock_line = TEST_LINE_NUM;
...
void CMockExpectParameters_gpioWrite(CMOCK_gpioWrite_CALL_INSTANCE* cmock_call_instance, gpioMap_t cmock_arg1, _Bool cmock_arg2);
void CMockExpectParameters_gpioWrite(CMOCK_gpioWrite_CALL_INSTANCE* cmock_call_instance, gpioMap_t cmock_arg1, _Bool cmock_arg2)
{
  memcpy((void*)(&cmock_call_instance->Expected_cmock_arg1), (void*)(&cmock_arg1),
         sizeof(gpioMap_t[sizeof(cmock_arg1) == sizeof(gpioMap_t) ? 1 : -1])); /* add gpioMap_t to :treat_as_array if this causes an error */
...
void gpioInit(gpioMap_t cmock_arg1, _Bool cmock_arg2)
{
  UNITY_LINE_TYPE cmock_line = TEST_LINE_NUM;
...
void CMockExpectParameters_gpioInit(CMOCK_gpioInit_CALL_INSTANCE* cmock_call_instance, gpioMap_t cmock_arg1, _Bool cmock_arg2);
void CMockExpectParameters_gpioInit(CMOCK_gpioInit_CALL_INSTANCE* cmock_call_instance, gpioMap_t cmock_arg1, _Bool cmock_arg2)
{
  memcpy((void*)(&cmock_call_instance->Expected_cmock_arg1), (void*)(&cmock_arg1),
         sizeof(gpioMap_t[sizeof(cmock_arg1) == sizeof(gpioMap_t) ? 1 : -1])); /* add gpioMap_t to :treat_as_array if this causes an error */
